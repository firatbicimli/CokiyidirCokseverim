const movie = [
  ...
  },
  {
    ...
    episodes: [
      { id: 336, title: 'Killer Of The Flower Moon - O', category: 'Film' },
      { id: 337, title: 'The White Lotus - C', category: 'Dizi'},
      { id: 338, title: 'Past Lives - O', category: 'Film' },
      { id: 339, title: 'Megalopolis - O', category: 'Film' },
      { id: 340, title: 'Sliding Doors - C - O', category: 'Film' },
      { id: 341, title: 'The Greatest Night In Pop - O', category: 'Belgesel' },
      { id: 342, title: 'Quincy - C', category: 'Belgesel' },
      { id: 343, title: 'Gran Trismo - C', category: 'Film' },
      { id: 343, title: 'The Fisher King - O', category: 'Film' },
      { id: 343, title: 'The Oldman - C', category: 'Dizi' },
      { id: 343, title: 'The Girl Dragon Tattoo - O', category: 'Film' },
      { id: 343, title: 'The Eastern Promises - O', category: 'Film' },
      { id: 343, title: 'Prometheus - C', category: 'Film' },
      { id: 344, title: 'Ben Folds & Nick Hornby - From Above - O', category: 'Şarkı' },
      { id: 345, title: 'Ramona Falls - Russia - O', category: 'Şarkı' },
      { id: 346, title: 'Lecomte De Bregot - Paris 1985 - O', category: 'Şarkı' },
      { id: 347, title: 'Gossip - Standing In The Way Of Control - O', category: 'Şarkı' },
      { id: 348, title: 'Bacao Rhythm & Steel Band - PIMP - O', category: 'Şarkı' },
      { id: 349, title: 'Tracy Chapman - Fast Car - O', category: 'Şarkı' },
      { id: 349, title: 'Blind Guardian - The Bard^s Song - O', category: 'Şarkı' },
      { id: 349, title: 'Grizzly Bear - Sleeping Ute - C', category: 'Şarkı' },
      { id: 349, title: 'John Grant - I Want To Go To Marz  - C', category: 'Şarkı' },
    ],
  },
];
