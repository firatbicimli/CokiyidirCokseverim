const movie = [
  ...
  },
  {
    ...
    episodes: [
      { id: 336, title: 'Sararmış Yapraklar - O', category: 'Film' },
      { id: 337, title: 'Kiss kiss Bang bang - 0', category: 'Film'},
      { id: 338, title: 'Phone Booth - O', category: 'Film' },
      { id: 339, title: 'No One Would Suspect The Truth - O', category: 'Belgesel' },
      { id: 340, title: 'The Tender Bar - C', category: 'Film' },
      { id: 341, title: 'The Equalizer 3 - C', category: 'Film' },
      { id: 342, title: 'Hava Muhalefeti - O', category: 'Film' },
      { id: 343, title: 'The Good The Bad The Ugly - C', category: 'Film' },
      { id: 344, title: 'Mayorga - Girl Crush - O', category: 'Şarkı' },
      { id: 345, title: 'Kid Frencescoli - Run,Run - O', category: 'Şarkı' },
      { id: 346, title: 'Tame Impala - One Night / All Night - O', category: 'Şarkı' },
      { id: 347, title: 'Arab Strap - Bliss - O', category: 'Şarkı' },
      { id: 348, title: 'TV On The Radio - DLZ - C', category: 'Şarkı' },
      { id: 349, title: 'Warpaint - Love Is To Die - C', category: 'Şarkı' },
      { id: 350, title: 'Derya Bengi - 100.Yılında Cumhuriyet^in Popüler Kültür Haritası - O', category: 'Kitap' },
    ],
  },
  {
    id: 1,
    title: "2. sezon bölüm 18",
    episodes: [
      { id: 351, title: 'Killer Of The Flower Moon - O', category: 'Film' },
      { id: 352, title: 'The White Lotus - C', category: 'Dizi'},
      { id: 353, title: 'Past Lives - O', category: 'Film' },
      { id: 354, title: 'Megalopolis - O', category: 'Film' },
      { id: 355, title: 'Sliding Doors - C - O', category: 'Film' },
      { id: 356, title: 'The Greatest Night In Pop - O', category: 'Belgesel' },
      { id: 357, title: 'Quincy - C', category: 'Belgesel' },
      { id: 358, title: 'Gran Trismo - C', category: 'Film' },
      { id: 359, title: 'The Fisher King - O', category: 'Film' },
      { id: 360, title: 'The Oldman - C', category: 'Dizi' },
      { id: 361, title: 'The Girl Dragon Tattoo - O', category: 'Film' },
      { id: 362, title: 'The Eastern Promises - O', category: 'Film' },
      { id: 363, title: 'Prometheus - C', category: 'Film' },
      { id: 364, title: 'Ben Folds & Nick Hornby - From Above - O', category: 'Şarkı' },
      { id: 365, title: 'Ramona Falls - Russia - O', category: 'Şarkı' },
      { id: 366, title: 'Lecomte De Bregot - Paris 1985 - O', category: 'Şarkı' },
      { id: 367, title: 'Gossip - Standing In The Way Of Control - O', category: 'Şarkı' },
      { id: 368, title: 'Bacao Rhythm & Steel Band - PIMP - O', category: 'Şarkı' },
      { id: 369, title: 'Tracy Chapman - Fast Car - O', category: 'Şarkı' },
      { id: 370, title: 'Blind Guardian - The Bard^s Song - O', category: 'Şarkı' },
      { id: 371, title: 'Grizzly Bear - Sleeping Ute - C', category: 'Şarkı' },
      { id: 372, title: 'John Grant - I Want To Go To Marz  - C', category: 'Şarkı' },
    ],
  },
  {
    id: 1,
    title: "2. sezon bölüm 19",
    episodes: [
      { id: 373, title: 'Pulp Fiction - O', category: 'Film' },
      { id: 374, title: 'Lock Stock - O', category: 'Film'},
      { id: 375, title: 'Snatch - C', category: 'Film' },
      { id: 376, title: 'The Big Short - O', category: 'Film' },
      { id: 377, title: 'Emprie Of The Sun - C', category: 'Film' },
      { id: 378, title: 'All Of Us Strangers - C', category: 'Belgesel' },
      { id: 379, title: 'Criminal Record - C', category: 'Dizi' },
      { id: 380, title: 'Tokyo Vice - C', category: 'Dizi' },
      { id: 381, title: 'A Season In Hakkari - C', category: 'Film' },
      { id: 382, title: 'Dumb and Dumber - C - O', category: 'Film' },
      { id: 383, title: 'Perfect Strangers - C - O', category: 'Dizi' },
      { id: 384, title: 'High Fidelity - C - O', category: 'Film' },
      { id: 386, title: 'Mildlife - Return To Centaurus - O', category: 'Şarkı' },
      { id: 387, title: 'The Last Dinner Party - Nothing Matters - O', category: 'Şarkı' },
      { id: 388, title: 'Nick Mulvey - Dancing For The Answers - O', category: 'Şarkı' },
      { id: 389, title: 'Lecomte Bregeot - Paris 1985 - O', category: 'Şarkı' },
      { id: 390, title: 'Josh Rouse - Flight Attendant - O', category: 'Şarkı' },
      { id: 391, title: 'Lisa Stansfield - All Around the World - O', category: 'Şarkı' },
      { id: 392, title: 'The Black Keys - I Forgot To Be Your Lover - O', category: 'Şarkı' },
      { id: 393, title: 'Royal Otis - Murder On The Dancefloor - O', category: 'Şarkı' },
      { id: 394, title: 'Great Mountain Fire - It^s Alright - C', category: 'Şarkı' },
      { id: 394, title: 'Architecture in Helsinki - Do the Whirlwind - C', category: 'Şarkı' },
      { id: 395, title: 'There She Goes - C', category: 'Kitap' },
      { id: 396, title: 'Ferit Edgü - Hakkari^de Bir Mevsim - C', category: 'Kitap' },
      { id: 397, title: 'Peter Watson - Büyük Bölünme - C', category: 'Kitap' },
      { id: 398, title: 'Peter Watson - Fikirler Tarihi - C', category: 'Kitap' },
      { id: 399, title: 'Nick Hornby - High Fidelity - C - O', category: 'Kitap' },
    ],
  },
  {
    id: 1,
    title: "2. sezon bölüm 20",
    episodes: [
      { id: 400, title: 'The Teacher^s Lounge - C - O', category: 'Film' },
      { id: 401, title: 'Counterpart - C', category: 'Dizi'},
      { id: 402, title: 'Boilingpoint - O', category: 'Dizi' },
      { id: 403, title: 'The Irishman - O', category: 'Film' },
      { id: 404, title: 'Safe Place - C', category: 'Film' },
      { id: 405, title: 'Now You See Me - O', category: 'Film' },
      { id: 406, title: 'Cujo - C', category: 'Film' },
      { id: 407, title: 'White Dog - C', category: 'Film' },
      { id: 408, title: 'The Boat That Rocked - C', category: 'Film' },
      { id: 409, title: '24 Hour Party People - O', category: 'Film' },
      { id: 410, title: 'Almost Famous - C', category: 'Film' },
      { id: 412, title: 'Spanky Wilson - Sunshine of Your Love - O', category: 'Şarkı' },
      { id: 413, title: 'The Skinner Brothers - Death From Above - O', category: 'Şarkı' },
      { id: 414, title: 'Death Lens - Cold World - O', category: 'Şarkı' },
      { id: 415, title: 'Chezile - Beanie - O', category: 'Şarkı' },
      { id: 416, title: 'Amoue - ILAVU - O', category: 'Şarkı' },
      { id: 417, title: 'Hooverphonic - Fake Is The New Dope - O', category: 'Şarkı' },
      { id: 418, title: 'Arc De Soleil - Strolling Sloth - C', category: 'Şarkı' },
      { id: 419, title: 'Sunflower Bean - I Was a Fool - C', category: 'Şarkı' },
      { id: 420, title: 'Sea Power - Waving Flags - C', category: 'Şarkı' },
      { id: 422, title: 'There She Goes - C', category: 'Kitap' },
      { id: 423, title: 'Benoit Peeters - Bir Şef Gibi - C', category: 'Kitap' },
    ],
  },
];
